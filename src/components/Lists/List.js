...
class List extends React.Component {
    ...
    for( var j in _object){
        ...
        ? ( 
            ...
            ? (
              ...
              this.forceOpen(),
              this.toStorage(this.props.where, this.props.what)
            )
  ...
  newFolderAction(){
    ...
    ? (
      this.addFolder(this.props.data, {
  ...
  renameFolderAction(){
    this.state.newFolder.length>0
    ? (
      this.rnmFolder(this.props.data, Utils.rtrim(this.state.newFolder))
    )
    : this.setState({
      'msg':'Por favor introduce un nombre válido'
    })
  ...
  removeFromFolderAction(){
    this.rmvFromFolder(this.props.data, this.state.idSelected, this.state.originId)
  }
  ...
  moveToFolderAction(){
    this.getItemToMove(this.props.data, this.state.idSelected, this.state.originId)
  }
  ...
  moveChildAction(){
    this.rmvFromMove(this.props.data, this.state.idSelected, this.state.originId);
    this.mvTo(this.props.data, this.state.movItemObject, this.state.destinyId);
  }
  ...
  moveFolderToFolderAction(){
    this.getFolderToMove(this.props.data, this.state.idSelected)
  }
  ...
  moveFolderAction(){
    this.rmvFolderFromMove(this.props.data, this.state.movFolderObject.id);
    this.mvFolderTo(this.props.data, this.state.movFolderObject, this.state.destinyId);
  }
  ...
  toStorage(_where, _what){
    ...
    schemma.listData[_where][_what] = this.props.data;
  ...
  render() {
    ...
    return (
      <div class="listSchemma_container_fixed">
        <div>{this.props.what}</div>
        <list>
          {
