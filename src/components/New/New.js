...
class New extends React.Component {
  ...
  componentDidMount(){
    ...
    API.action('getNew', {'id' : this.props.origen }, this.onSuccess, this.onError, 'GET', false, true);
  }
  componentWillUpdate(){
      ...
      <div className='new' >
        <div className='row'>
          <div className='col-xs-12 col-md-12'>
            <div className='new_rot' >{this.translate('content.newEpisodes')} {this.state.dataOrigen}</div>
          </div>
        </div>
